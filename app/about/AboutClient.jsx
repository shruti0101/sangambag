    ...
    <>
        ...
        <div className=" mx-auto px-6 md:px-16 grid md:grid-cols-2 gap-10 md:gap-16 items-center">
          <div className=" text-black">
            ...
            <div className="text-justify text-lg">
              <Reveal>
                <p>
                  Established in 1988, Sangam Plastic Industries is a leading
                  Garbage Bag Manufacturer in India, known for delivering
                  reliable, hygienic, and cost-effective waste management
                  solutions. With over three decades of industry experience, we
                  have built a strong reputation as a trusted manufacturer,
                  exporter, and supplier serving clients across the country.
                </p>
              </Reveal>

              <Reveal delay={0.2}>
                <p>
                  We specialize in manufacturing a wide range of products
                  including garbage bags, disposable bio dustbin bags, hospital
                  garbage bags, plastic dustbins, pedal bins, wheeled bins,
                  bio-medical waste bins, and plastic pallets. Our products are
                  designed to meet the growing demand for safe, eco-friendly,
                  and efficient waste disposal across multiple sectors.
                </p>
              </Reveal>
          ...
          <Reveal>
            <img src="/bag/try4.jpg" className="w-full h-full" />
          </Reveal>
        </div>
      </section>
      ...
      <section className="py-8 md:py-12 bg-white">
        <div className="max-w-7xl mx-auto px-6 relative  grid md:grid-cols-2 gap-8 md:gap-16 items-center">
          ...
          <div>
            <Reveal>
              <h2 className="text-4xl font-semibold mb-5 md:mb-10">Our Vision</h2>
            </Reveal>

            <div className="border-l-4 border-green-600 pl-8 space-y-5 text-gray-600">
              <Reveal>
                <p>
                  At Sangam Plastic Industries, our vision is to be recognized
                  as India’s most trusted and innovative Garbage Bag
                  Manufacturer, delivering high-quality, hygienic, and
                  environmentally responsible waste management solutions. We
                  strive to support cleaner surroundings by offering products
                  that meet the evolving needs of homes, hospitals, offices,
              ...
              <Reveal delay={0.2}>
                <p>
                  As a forward-thinking Disposable Bio Dustbin Bag Manufacturer
                  and Hospital Garbage Bag Manufacturer, we aim to set new
                  benchmarks in safety, durability, and sustainability. Our
                  focus is on developing eco-friendly and high-performance
                  garbage bags that promote efficient waste segregation and
              ...
              <Reveal delay={0.4}>
                <p>
                  We aspire to lead the industry through continuous innovation,
                  strict quality standards, and customer-centric values, making
                  reliable waste management products accessible across India.
                  Our vision is to empower a cleaner, safer, and healthier
          ...
          <div className="grid md:grid-cols-3 gap-5 md:gap-10">
            ...
            <Reveal>
              <div className="group relative overflow-hidden bg-white/70 backdrop-blur-md p-10 rounded-3xl border border-gray-200 shadow-lg hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 h-[350px]">
                ...
                <p className="relative z-10 text-black leading-relaxed text-sm">
                  Delivering High-Quality Products: As an experienced Disposable
                  Bio Dustbin Bag Manufacturer and Hospital Garbage Bag
                  Manufacturer, we focus on producing strong, leak-proof, and
                  eco-friendly garbage bags along with waste management products
                  that meet strict quality and hygiene standards. Every product
                  is designed for performance, safety, and long-term usability.
                </p>
              </div>
            </Reveal>
            ...
            <Reveal delay={0.2}>
              <div className="group relative overflow-hidden bg-white/70 backdrop-blur-md p-10 rounded-3xl border border-gray-200 shadow-lg hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 h-[350px]">
                ...
                <p className="relative z-10 text-black leading-relaxed text-sm">
                  Ensuring Customer Satisfaction: We place our customers at the
                  center of everything we do by offering customized solutions,
                  bulk order capabilities, timely delivery, and dependable
                  after-sales support. Our goal is to build long-term
                  partnerships through trust, reliability, and consistent
                  service excellence.
                </p>
              </div>
            </Reveal>
      ...
      <section className="py-8 md:py-12 bg-white">
        <div className="w-full mx-auto px-6 md:px-16">
          <Reveal>
            <h2 className="text-4xl font-semibold mb-6 md:mb-12 text-center lg:text-left">
              Our Core Values
            </h2>
          </Reveal>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="border-l-4 border-green-600 pl-8 space-y-10 text-black">
              <Reveal>
                <p>
                  <b>Quality Excellence:</b> We are committed to delivering
                  superior quality across all our products. As a dependable
                  Disposable Bio Dustbin Bag Manufacturer and Hospital Garbage
                  Bag Manufacturer, we ensure that every garbage bag meets
                  strict durability, hygiene, and safety standards through
              ...
              <Reveal delay={0.2}>
                <p>
                  <b>Customer-Centric Approach:</b> Our customers remain at the
                  center of everything we do. We focus on transparent
                  communication, timely service, and customized solutions that
                  address specific client requirements and foster long-term
                  partnerships.
                </p>
              </Reveal>
              ...
              <Reveal delay={0.4}>
                <p>
                  <b>Integrity & Trust:</b> Ethical business practices, honest
                  communication, and consistent reliability form the foundation
                  of our organization. Clients trust us to deliver high-quality
                  products and honor our commitments at every stage.
                </p>
              </Reveal>

              <Reveal delay={0.6}>
                <p>
                  <b>Innovation & Progress:</b> We continuously adopt modern
                  technologies, improve product designs, and enhance
                  manufacturing processes to remain competitive and responsive
              ...
              <Reveal delay={0.8}>
                <p>
                  <b>Sustainability & Responsibility:</b> Environmental
                  responsibility is integral to our values. We prioritize
                  eco-friendly materials, recyclable products, and sustainable
                  manufacturing practices to minimize environmental impact while
                  supporting cleaner and healthier surroundings.
                </p>
              </Reveal>
            </div>
          ...
          <div className="backdrop-blur-xl bg-white/5 border border-white/10 rounded-3xl p-10 md:p-16 text-center text-white shadow-2xl">
            ...
            <Reveal delay={0.2}>
              <p className="text-white max-w-3xl mx-auto leading-relaxed mb-8 text-md md:text-xl">
                ...
                , a trusted Garbage Bag Manufacturer delivering reliable and
                hygienic waste management solutions across India. We support
                businesses, healthcare facilities, and institutions with bulk
                supply, customized solutions, and expert assistance.
              </p>
            </Reveal>
