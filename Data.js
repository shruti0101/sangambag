...
export const categories = [
  ...
  id: "biodegradable-garbage-bags",
  name: "Biodegradable Garbage Bags",
  metaTitle: "Biodegradable Garbage Bags Manufacturer & Supplier",
  metaDescription:
    "High-quality biodegradable garbage bags made from eco-friendly materials. Strong, leak-proof, compostable, and ideal for homes, offices, hospitals, and commercial waste management.",

  description: [
    { type: "h2", text: "Overview" },
    {
      type: "p",
      text: "Our Biodegradable Garbage Bags are an eco-friendly alternative to traditional plastic waste bags. Manufactured using compostable and biodegradable materials, these bags naturally decompose over time without harming the environment. They are strong, leak-resistant, and ideal for residential, commercial, hospital, and industrial waste management."
    },
    { type: "h2", text: "Key Features of Biodegradable Garbage Bags:" },
    {
      type: "ul",
      items: [
        "<strong>Eco-Friendly Material:</strong> Made from biodegradable compounds that break down naturally without releasing toxic residues.",
        "<strong>High Strength & Durability:</strong> Designed to handle wet and dry waste without tearing or leaking.",
        "<strong>Leak-Proof Design:</strong> Strong sealing and thickness prevent spillage and odor leakage.",
        "<strong>Compostable Option Available:</strong> Suitable for organic waste disposal and composting systems.",
        "<strong>Multiple Size Variants:</strong> Available in various sizes and thicknesses for household and commercial use.",
        "<strong>Safe & Non-Toxic:</strong> Free from harmful chemicals, making them safe for everyday use."
      ]
    }
  ],

  specs: [
    { label: "Material", value: "Biodegradable / Compostable Plastic" },
    { label: "Capacity", value: "5L – 120L (Custom Sizes Available)" },
    { label: "Thickness", value: "15 – 50 Micron" },
    { label: "Color Options", value: "Green, Black, Blue (Custom Available)" },
    { label: "Usage Type", value: "Wet & Dry Waste" },
    { label: "Packaging", value: "Roll / Loose Packing" }
  ],
  ...
  // category 1 disposable garbage bags
  // {
